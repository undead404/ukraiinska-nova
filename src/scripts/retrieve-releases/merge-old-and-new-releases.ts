import type {
  MusicRelease,
  MusicReleaseRecord,
} from '../../common/schemata.js';
import calculateReleaseIdentity from '../../helpers/calculate-release-identity.js';
import isReleaseRecordObsolete from '../../helpers/is-release-record-obsolete.js';

export default function mergeOldAndNewReleases(
  oldReleases: MusicReleaseRecord[],
  freshReleases: MusicRelease[],
): {
