...
const environmentSchema = object({
  BLUESKY_IDENTIFIER_FOR_SPOTIFY: pipe(string(), minLength(5)),
  BLUESKY_PASSWORD_FOR_SPOTIFY: pipe(string(), minLength(8)),
  ...
  TELEGRAM_CHANNEL_FOR_SPOTIFY: pipe(string(), nonEmpty()),
});
